...
const lan_continue_selector = "#q2 > div > div.menu > a.forward.button-blue-big.button-blue-big-forward.ani-bg";
...
const hints_continue_selector = "#q2 > div > div.menu > a.forward.button-blue-big.button-blue-big-forward.ani-bg";
const zipcode_selector = "#plz";
const zipcode_continue_selector = "#q3 > div > div.menu > a.forward.button-blue-big.button-blue-big-forward.ani-bg";

const provider_container_selector = "#select2-provider-container";
const provider_search_input_selector = "#mbody > span > span > span.select2-search.select2-search--dropdown > input";
const provider_continue_selector = "#q4 > div > div.menu > a.forward.button-blue-big.button-blue-big-forward.ani-bg";
...
const service_continue_selector = "#q24 > div > div.menu > a.forward.button-blue-big.button-blue-big-forward.ani-bg";
...
const throttling_continue_selector = "#q13 > div > div.menu > a.forward.button-blue-big.button-blue-big-forward.ani-bg";

const unhappy_selector = "#q7 > div > div.answer.answer-customer > ul > li.last > a";
const start_test_2_selector = "#q7 > div > div.menu > a.forward.button-blue-big.button-blue-big-forward.ani-bg";
